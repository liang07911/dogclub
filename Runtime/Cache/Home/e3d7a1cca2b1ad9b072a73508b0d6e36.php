...
<div class="sear">
				...
				<div class="form">
					<form action="/index.php?s=/home/dog/father_search.html" method="post">
						...
						<div class="line_button center w_476 clearfix">
							<a href="<?php echo U('Dog/father_insert',array('id'=>$dog_id));?>" class="button_a pull_left" style="margin-right: 30px;padding: 0;text-align: center;">直接录入</a>
							<input type="button" value="查询" id="submits">
							<a href="<?php echo U('Dog/mother_search');?>" class="button_a pull_right b_c_red">跳过</a>
						</div>
					</form>
				</div>
			...
			<?php if($res == 1): if(!empty($father)): ?><div class="Result">
				...
				<div class="line_button p_l_0">
					<a href="<?php echo U('Dog/father_link',array('id'=>$father['id']));?>" class="button_a center">关联</a>
				</div>
			</div>
			<!--查询到结果输出 ent-->
			<?php else: ?>
