...
<section class="box">
	...
	<div class="sear">
				...
				<div class="form">
					<form action="/index.php?s=/home/dog/mother_search2/did/42.html" method="post">
						...
						<div class="line_button center w_476 clearfix">
							...
							<a href="<?php echo U('Dog/mother_insert',array('id'=>$dog_id,'act'=>'do'));?>" class="button_a pull_right b_c_red" style="padding: 0;text-align: center;">直接录入</a>
			...
			<div class="Result">
					...
					<ul>
						...
						<li class="fa">
							<ul class="clearfix">
								...
								<li><?php echo ($mother["birthday"]); ?></li>
				...
				<div class="line_button p_l_0">
					<a href="<?php echo U('Dog/mother_link2',array('id'=>$mother['id'],'did'=>$dog_id));?>" class="button_a center">关联</a>
				</div>
			</div>
			<!--查询到结果输出 end-->
			<?php else: ?>
