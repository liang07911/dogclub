...
<div class="container clearfix">
		<div class="left">
			<h3>会员信息</h3>
			<ul>
				<li><a href="<?php echo U('User/index');?>">会员基本信息</a></li>
				<li><a href="<?php echo U('User/dog_list');?>" class="active">我的犬只</a></li>
		...
		<div class="right">
			<div class="sear">
				...
				<div class="form">
					<form action="<?php echo U('Dog/dog_update');?>" method="post" enctype="multipart/form-data">
						<div class="titleh4">
							<h4>| 必填项</h4>
						</div>
						<div class="line_double">
							...
							<div class="rights clearfix">
								<input type="text" name="dog_name" value="<?php echo ($dogInfo["dog_name"]); ?>" class="error_message">
						...
						<div class="line_double clearfix">
							...
							<div class="rights clearfix">
								<?php if($dogInfo["dog_sex"] == 0): ?><input type="radio" name="dog_sex" checked="checked" value="0"/><span>公</span>
									<input type="radio" name="dog_sex" value="1"/><span>母</span>
								<?php else: ?>
									<input type="radio" name="dog_sex" value="0"/><span>公</span>
									<input type="radio" name="dog_sex" checked="checked" value="1"/><span>母</span><?php endif; ?>
							</div>
						</div>
						<div class="line_double">
							<div class="left"><span>耳号</span></div>
							<div class="rights clearfix">
								<input type="text" name="ear_num" value="<?php echo ($dogInfo["ear_num"]); ?>" class="error_message">
								<span class="error_message"></span>
							</div>
						</div>
						<div class="line_double">
							...
							<div class="rights clearfix">
								<input type="text" name="mic_num" value="<?php echo ($dogInfo["mic_num"]); ?>" class="error_message">
								<span class="error_message"></span>
							</div>
						</div>
						<div class="line_double">
							...
							<div class="rights clearfix">
								<input type="text" name="studbook" value="<?php echo ($dogInfo["studbook"]); ?>" class="error_message">
								<span class="error_message"></span>
							</div>
						</div>
						<div class="line_double">
							...
							<div class="rights p_relative  clearfix">
								<input type="text" name="birthday" class="error_message" value="<?php echo (date('Y-m-d',$dogInfo["birthday"])); ?>"><span class="error_message"></span>
								<div id="Date_box"></div>
						...
						<div class="line_double">
							...
							<div class="rights clearfix">
								<input type="text" name="dog_owner" value="<?php echo ($dogInfo["dog_owner"]); ?>" class="error_message">
								<span class="error_message"></span>
							</div>
						</div>
						<div class="line_double">
						...
						<div class="line_double">
							...
							<div class="rights clearfix">
								<input type="text" name="reproduce" value="<?php echo ($dogInfo["reproduce"]); ?>" class="error_message">
								<span class="error_message"></span>
							</div>
						</div>
						<div class="titleh4">
						...
						<div class="line_double">
							...
							<div class="rights"><input type="text" name="dog_dna" value="<?php echo ($dogInfo["dog_dna"]); ?>"></div>
						</div>
						<div class="line_double">
							<div class="left"><span>类别</span></div>
							<div class="rights"><input type="text" name="type" value="<?php echo ($dogInfo["type"]); ?>"></div>
						</div>
						<div class="line_double">
							<div class="left"><span>训练资格</span></div>
							<div class="rights"><input type="text" name="practice" value="<?php echo ($dogInfo["practice"]); ?>"></div>
						</div>
						<div class="line_double">
							<div class="left"><span>髋/肘鉴定</span></div>
							<div class="rights"><input type="text" name="appraisal" value="<?php echo ($dogInfo["appraisal"]); ?>"></div>
						</div>
						<div class="line_double">
							<div class="left"><span>国外证书号</span></div>
							<div class="rights"><input type="text" name="foreign_num" value="<?php echo ($dogInfo["foreign_num"]); ?>"></div>
						</div>
						<div class="line_double">
							<div class="left"><span>照片</span></div>
							<div class="rights files">
								 <a href="javascript:;">上传</a>
								 <?php if($dogInfo["pic_url"] != '' ): ?><img src="<?php echo ($dogInfo["pic_url"]); ?>" id="xmTanImg">
								 <?php else: ?>
						...
						<input type="hidden" name="dogid" value="<?php echo ($id); ?>">
					</form>
				</div>
			</div>
		</div>
